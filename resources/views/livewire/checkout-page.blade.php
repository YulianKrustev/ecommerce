                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-4">
                            ...
                            <input wire:model="street_adress" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('street_address') border-red-500 @enderror" id="address" type="text">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input wire:model="zip_cide" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('zip_code') border-red-500 @enderror" id="zip" type="text">
                                @error('zip_code')
                                <div class="text-red-500 text-sm">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2">
                        ...
                        <li>
                            <input wire:model="payment_method" class="hidden peer" type="radio" value="stripe">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-1 min-w-0 ms-4">
                                        ...
                                        <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                                            Quantity: {{ $item['quantity'] }} x {{ Number::currency($item['price'], 'EUR') }}
                                        </p>
                                    </div>
                                    <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                        {{ Number::currency($item['quantity'] * $item['price'] , 'EUR') }}
                                    </div>
                                </div>
                            </li>
                        @endforeach
